# 🐍 Foundations of Data Science Lab Codes
...
8. Create a synthetic dataset(.csv) to work upon and design a python program to read and print that data
9. Create a NumPy array with specific characteristics and perform various operations to analyze and manipulate the data.

    - Create a 2D NumPy array of shape (4,5) with random integers between 1 and 50
    - Calculate the sum
    - Find the maximum value
    - Calculate the mean
    - Sum of each row
    - Transpose the array
    - Filter Elements: Create a Boolean mask to find all elements greater than 25
